...
file { "gradle-jenkins":
  ...
  source   => '/vagrant/jenkins_files/hudson.plugins.gradle.Gradle.xml',
  ensure   => "present",
  owner	   => 'jenkins',
  group    => 'jenkins',
...
file { "git-jenkins":
  ...
  source   => '/vagrant/jenkins_files/hudson.plugins.git.GitSCM.xml',
  ensure   => "present",
  owner	   => 'jenkins',
  group    => 'jenkins',
...
file { "jenkins-project-config":
  ...
  source   => '/vagrant/jenkins_files/config.xml',
  ensure   => "present",
  owner	   => 'jenkins',
  group    => 'jenkins',
